export const MONGODB_CONNECTION =
  "mongodb+srv://admin:admin123456@cluster0.x15gj.mongodb.net/taskMangementProject?retryWrites=true&w=majority&appName=Cluster0";
...
export const EMAIL_USER = "tayyabmd00001@gmail.com";
export const EMAIL_PASSWORD = "qbos oawe npgz edgc";
